...
def scanWithinWindow(String githubCredentialId, String dockerImgName, String githubOwner, String repositoryPrefix, String scanWindowHrs, String excludeStrings, String slackChannel="") {
