...
class Docker implements Serializable {
  ...
  static def runTestImage(ctx) {
    ...
    ctx.sh("docker run --rm -i -v \$(pwd)/test-output:/home/node/test-output -v \$(pwd)/app:/home/node/app -v \$(pwd)/test:/home/node/test -v \$(pwd)/package.json:/home/node/package.json defradigital/node-development:1.2.11-node16.13.0 /bin/sh -c 'npm install; npm run test'")
  }
